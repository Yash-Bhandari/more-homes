// Social Links - Updated April 20, 2025
function noop() { }
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-7xj9ed");
...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "svelte-7xj9ed");
			attr(li, "class", "svelte-7xj9ed");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h2, "class", "heading svelte-7xj9ed");
			attr(ul, "class", "svelte-7xj9ed");
			attr(div, "class", "card svelte-7xj9ed");
			attr(div, "id", "contact");
			attr(section, "class", "section-container svelte-7xj9ed");
		},
		m(target, anchor) {
