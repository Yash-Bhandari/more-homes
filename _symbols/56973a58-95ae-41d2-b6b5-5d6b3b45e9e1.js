// Accordion - Updated April 18, 2025
function noop() { }
const identity = x => x;
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if ((!current || dirty & /*items*/ 1) && raw_value !== (raw_value = /*item*/ ctx[7].description.html + "")) div.innerHTML = raw_value;		},
		i(local) {
			if (current) return;
...
function create_each_block(key_1, ctx) {
	...
	let if_block = /*isActive*/ ctx[2][/*i*/ ctx[9]] && create_if_block(ctx);
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if ((!current || dirty & /*items*/ 1) && t0_value !== (t0_value = /*i*/ ctx[9] + 1 + "")) set_data(t0, t0_value);
			if ((!current || dirty & /*items*/ 1) && t2_value !== (t2_value = /*item*/ ctx[7].title + "")) set_data(t2, t2_value);

			if (/*isActive*/ ctx[2][/*i*/ ctx[9]]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty & /*isActive, items*/ 5) {
			...
			if (!current || dirty & /*isActive, items*/ 5) {
				toggle_class(div, "active", /*isActive*/ ctx[2][/*i*/ ctx[9]]);
			}
		},
		i(local) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div, "class", "accordion svelte-12ft0zk");
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*isActive, items, toggleItem*/ 13) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [items, heading, isActive, toggleItem, props, click_handler];
}
