...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			const head_nodes = head_selector('svelte-12d3742', document.head);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	return [content, title, favicon, description];
}
...
function instance$4($$self, $$props, $$invalidate) {
	...
	return [heading, email, social, title, favicon, description];
}
...
function create_each_block_1$1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*nav*/ 1 && t_value !== (t_value = /*link*/ ctx[5].label + "")) set_data(t, t_value);

			if (dirty & /*nav*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[5].url)) {
				attr(a, "href", a_href_value);
			}
		},
		d(detaching) {
...
function create_each_block$2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (!current || dirty & /*social*/ 2 && a_aria_label_value !== (a_aria_label_value = /*link*/ ctx[5].label)) {
				attr(a, "aria-label", a_aria_label_value);
			}
		},
		i(local) {
...
function instance$5($$self, $$props, $$invalidate) {
	...
	return [nav, social, title, favicon, description];
}
...
class Component$6 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$6, null, safe_not_equal, { title: 0, favicon: 1, description: 2 });
	}
}
...
function create_fragment$6(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				description: "More Homes Canada is a coalition of housing advocacy groups from across the country. Together, we are fighting to end Canada’s housing shortage."
			}
		});
	...
	component_2 = new Component$3({
			props: {
				...
				description: "More Homes Canada is a coalition of housing advocacy groups from across the country. Together, we are fighting to end Canada’s housing shortage.",
				content: {
					"html": "<h2 id=\"pressreleasefederalinfrastructurefundingwillboosthomebuildingputonusonprovincestocutredtape\"><strong>PRESS RELEASE: Federal infrastructure funding will boost home building, put onus on provinces to cut red tape</strong></h2>\n<p>April 2, 2024</p>\n<hr>\n<p><strong>More Homes Canada,</strong> a coalition of pro-housing groups from across the country, is pleased to see the announcement of a $6B federal infrastructure fund designed to support housing construction and cut back on harmful red tape.</p>\n<p>The Canada Housing Infrastructure Fund will finance critical infrastructure upgrades that communities need in order to accommodate more homes. Crucially, it earmarks $5 billion for provinces and territories that commit to reforming planning rules that stifle housing construction.</p>\n<p>“The onus is now on provincial and municipal governments to unlock federal infrastructure funding by legalizing the housing forms we desperately need,” said Yash Bhandari of More Homes Canada.</p>\n<p>The announcement should serve as a wake up call for provinces like Ontario, whose government recently announced that they would not legalize fourplexes provincewide.</p>\n<p>“We need every region to commit to reforms or else the crisis will only spread and worsen in new areas,” said Colleen Bailey of More Neighbours Toronto. “This should be a signal for Premiers leaning toward NIMBY [Not In My Backyard] policies to re-evaluate and commit to building strong municipalities with a variety of housing types that welcome new residents.”</p>\n<p>The fund will make the most of the upcoming Housing Design Catalogue by rewarding municipalities who allow designs to be constructed as-of-right, bypassing a rezoning process that can often take years.</p>\n<p>“Canada has some of the longest approval times in the world. Standardized designs improve construction speed and costs, but making municipal approvals as-of-right is vital to addressing the housing shortage quickly,” said Russil Wvong of Abundant Housing Vancouver.</p>\n<p>The announcement also ties transit funding to high-density housing and the removal of parking minimums near high-frequency transit.</p>\n<p>“This is the action that we’ve been waiting for from the federal government,” said Willem Klumpenhouwer of More Neighbours Calgary. “We need to make the most of our public investments to allow young people, new families and seniors to find suitable housing where they need it. With this federal funding, it is now time for provincial and municipal governments to step up.”</p>\n<hr>\n<p>For more information, please contact:</p>\n<p>Yash Bhandari<br />\nMore Homes Canada<br />\n<a href=\"mailto:info@morehomescanada.ca\">info@morehomescanada.ca</a><br />\n<a href=\"https://www.morehomescanada.ca/\">https://www.morehomescanada.ca/</a></p>\n<p><br></p>",
					"markdown": "## **PRESS RELEASE: Federal infrastructure funding will boost home building, put onus on provinces to cut red tape**\n\nApril 2, 2024\n<hr>\n\n**More Homes Canada,** a coalition of pro-housing groups from across the country, is pleased to see the announcement of a $6B federal infrastructure fund designed to support housing construction and cut back on harmful red tape.\n\nThe Canada Housing Infrastructure Fund will finance critical infrastructure upgrades that communities need in order to accommodate more homes. Crucially, it earmarks $5 billion for provinces and territories that commit to reforming planning rules that stifle housing construction.\n\n“The onus is now on provincial and municipal governments to unlock federal infrastructure funding by legalizing the housing forms we desperately need,” said Yash Bhandari of More Homes Canada.\n\nThe announcement should serve as a wake up call for provinces like Ontario, whose government recently announced that they would not legalize fourplexes provincewide.\n\n“We need every region to commit to reforms or else the crisis will only spread and worsen in new areas,” said Colleen Bailey of More Neighbours Toronto. “This should be a signal for Premiers leaning toward NIMBY [Not In My Backyard] policies to re-evaluate and commit to building strong municipalities with a variety of housing types that welcome new residents.”\n\nThe fund will make the most of the upcoming Housing Design Catalogue by rewarding municipalities who allow designs to be constructed as-of-right, bypassing a rezoning process that can often take years.\n\n“Canada has some of the longest approval times in the world. Standardized designs improve construction speed and costs, but making municipal approvals as-of-right is vital to addressing the housing shortage quickly,” said Russil Wvong of Abundant Housing Vancouver.\n\nThe announcement also ties transit funding to high-density housing and the removal of parking minimums near high-frequency transit.\n\n“This is the action that we’ve been waiting for from the federal government,” said Willem Klumpenhouwer of More Neighbours Calgary. “We need to make the most of our public investments to allow young people, new families and seniors to find suitable housing where they need it. With this federal funding, it is now time for provincial and municipal governments to step up.”\n\n<hr>\n\nFor more information, please contact:\n\nYash Bhandari  \nMore Homes Canada  \n[info@morehomescanada.ca](<mailto:info@morehomescanada.ca>)  \n[https://www.morehomescanada.ca/](<https://www.morehomescanada.ca/>)\n\n<br>\n\n"
				}
			}
		});
