...
function create_fragment$6(ctx) {
	...
	component_2 = new Component$3({
			props: {
				...
				description: "More Homes Canada is a coalition of housing advocacy groups from across the country. Together, we are fighting to end Canada’s housing shortage.",
				content: {
					"html": "<h2 id=\"whattheheckiszoninganyways\">What the heck is zoning anyways?</h2>\n<p>Zoning is a set of regulations that govern how land can be used. It divides areas into different zones, specifying what types of activities or developments are allowed in each zone, such as residential, commercial, or industrial. The problem is that existing zoning restrictions are so restrictive that it’s almost impossible to build affordable housing in our cities. All across the country, zoning regulations are being amended to allow for denser forms of housing to be built in neighbourhoods that were previously restricted to detached homes. </p>",
					"markdown": "## What the heck is zoning anyways? \n\nZoning is a set of regulations that govern how land can be used. It divides areas into different zones, specifying what types of activities or developments are allowed in each zone, such as residential, commercial, or industrial. The problem is that existing zoning restrictions are so restrictive that it’s almost impossible to build affordable housing in our cities. All across the country, zoning regulations are being amended to allow for denser forms of housing to be built in neighbourhoods that were previously restricted to detached homes. \n\n"
				}
			}
		});
